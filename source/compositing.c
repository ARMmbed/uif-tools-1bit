...
#if YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_BIT_BAND_PRESENT
#define SRAM_BASE        YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_BIT_BAND_RAM_BASE
#define BITBAND_RAM_BASE YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_BIT_BAND_BIT_BAND_BASE
#else
